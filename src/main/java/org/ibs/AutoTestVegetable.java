...
public class AutoTestVegetable {
    @Owner("Danil Pak")
    @DisplayName("Проверка добавления товара типа 'Овощ' в список")
    @Test
    void test() {
        ...
        //WebElement titleAddingGoods = driver.findElement(By.xpath("//h5[@id='editModalLabel']"));
         ...
         */
        WebElement btnInputNameOfGoods = driver.findElement(By.xpath(
                "//input[@id='name']"));
        btnInputNameOfGoods.sendKeys("Момордика");

        WebElement btnTypeOfGoods = driver.findElement(By.xpath(
                "//select[@id='type']/..//option[@value='VEGETABLE']"));
        btnTypeOfGoods.click();

        WebElement btnCheckBoxExotic = driver.findElement(By.xpath(
                "//input[@id='exotic']"));
        ...
        WebElement titleRow5 = driver.findElement(By.xpath(
                "//tr[5]/th[@scope='row']"));
        Assertions.assertEquals("5", titleRow5.getText(), "Not add");

        /** Нажать на кнопку "Добавить"
         */
        WebElement btnAdd1 = driver.findElement(By.xpath(
                "//button[@data-toggle='modal']"));
        btnAdd1.click();

        /** Ввести данные товара (без чек-бокса) в соответствующие в поля
         */
        WebElement btnInputNameOfGoods1 = driver.findElement(By.xpath(
                "//input[@id='name']"));
        btnInputNameOfGoods1.sendKeys("Картофель");
         ...
         */
        WebElement btnSandbox1 = driver.findElement(By.xpath(
                "//a[@class='nav-link dropdown-toggle']"));
        btnSandbox1.click();
